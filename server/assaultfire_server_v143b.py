...
V139_CURRENT_HANDLER_IDS = frozenset((40960, 40962, 40964, 40968, 41216, 41223, 41226, 41229, 41232, 41235, 41239, 41244, 41266, 41731, 41813, 41888, 65285))
...
print("[BOOT] BUILD=v143b-STABLE + DS SPAWNER r11 + v48 LAZY/LATCH + v72 ZERO-DSKEY + SHARED ROOM JOIN (NO NEW-ACCOUNT BRANCH)")
