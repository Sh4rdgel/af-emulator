...
Get-Content "<game-root>\TCLS\config\APClient.dat" | Select-Object -Last 1
~~~
...
~~~powershell
.\.venv\Scripts\python.exe .\tools\patches\patch_tcls_apclient_raw_pem.py "<game-root>\TCLS\Tenio\TCLS.dll"
~~~
